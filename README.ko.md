...
AC P2P Info는 미러링된 PS5 유선 LAN 트래픽을 이용해 Armored Core의 P2P 연결 상태를 모니터링하는 Windows 프로그램입니다.
...
6. AC P2P Info를 실행하고 미러링 트래픽을 받는 Ethernet 어댑터를 선택합니다.
